...
def txt2img(visual_path="visual_val_gt"):
    ...
    gt_json_path = '/mnt/data2/uavdt/annotations/test.json'
    img_path = '/mnt/data2/uavdt/UAVDT_test'
    ...
    test_json_path = '/mnt/data2/UAVDT/annotations/val.json'
    test_img_path = '/mnt/data2/UAVDT/val/'
    tsfiles = gb.glob('/home/fan/Documents/GeanyProject/UAVTrack/output/val/tracks/.txt')
    test_show_video_names = [os.path.splitext(Path(f).parts[-1])[0] for f in tsfiles]
    ...
    for show_video_name in show_video_names:
        ...
        if visual_path == "visual_val_gt":
            ...
            txt_path = '/home/fan/Documents/GeanyProject/UAVTrack/output/val/tracks/'+ show_video_name + '.txt'
        else:
        ...
        with open(txt_path, 'r') as f:
            for line in f.readlines():
                ...
                if visual_path == "visual_val_gt":
                    if mark == 0 or label not in valid_labels or label in \
                    ignore_labels or vis_ratio <= 0:
                        continue
        ...
        for img_id in sorted(txt_dict.keys()):
            ...
            for bbox in txt_dict[img_id]:
                ...
                cv2.putText(img, "{}".format(int(bbox[4])), (int(bbox[0]), int(bbox[1])), 
                cv2.FONT_HERSHEY_SIMPLEX, 0.8, color_list[bbox[4]%79].tolist(), 2)

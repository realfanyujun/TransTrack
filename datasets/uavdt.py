...
def make_uavdt_transforms(image_set, args):
...
def build(image_set, args):
    ...
    assert root.exists(), f'provided UAVDT path {root} does not exist'
    mode = 'instances'
    PATHS = {
        #"train": (root / "train", root / "annotations" / 'train_half.json'),
        #"val": (root / "val", root / "annotations" / 'val_half.json'),
    ...
    dataset = CocoDetection(img_folder, ann_file, transforms=make_uavdt_transforms(image_set, args), return_masks=args.masks,
